...
- [**CarolinianEvents**](https://github.com/ScarXiFy/Carolinian-Events-Management-System) — Event management system for USC. Handles event creation, registration, and scheduling so student orgs don't have to do it over group chats.
